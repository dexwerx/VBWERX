...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    ' Allocate a spot for it on the thread heap
    Dim pThis As Long
...
Private Function SIID$(ByVal riid As Long)
    Const IID_CB As Long = 16&  ' GUID/IID size in bytes
    DeRef(VarPtr(SIID)) = SysAllocStringByteLen(riid, IID_CB)
End Function
...
Private Function IEnumVARIANT_Next(ByRef This As TENUMERATOR, _
    ...
    If rgVar = NULL_ Then IEnumVARIANT_Next = E_POINTER: Exit Function
